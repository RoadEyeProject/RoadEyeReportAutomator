...
public class TestBase {
  ...
  protected void scroll(WebElement element, String direction) {
   ...
   switch (direction.toLowerCase()) {
    case "left":
     startX = location.getX() + (int) (size.width * 0.8);
     endX = location.getX() + (int) (size.width * 0.2);
     startY = location.getY() + size.height / 2;
     endY = startY;
     break;
    case "right":
     startX = location.getX() + (int) (size.width * 0.2);
     endX = location.getX() + (int) (size.width * 0.8);
     startY = location.getY() + size.height / 2;
     endY = startY;
     break;
    default:
